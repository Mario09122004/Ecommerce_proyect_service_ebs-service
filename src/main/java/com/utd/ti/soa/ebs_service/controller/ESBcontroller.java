...
public class ESBcontroller {
    ...
    public Mono<ResponseEntity<String>> createUser(@RequestBody User user) {
        ...
        return webClient.post()
                .uri("http://ecommerce_proyect_service_users.railway.internal:3001/api/users")
    ...
    public Mono<ResponseEntity<String>> updateUser(@PathVariable("id") String id,
        ...
        return webClient.patch()
                .uri("http://ecommerce_proyect_service_users.railway.internal:3001/api/users/" + id)
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(user)
                .retrieve()
                .bodyToMono(String.class)
    ...
    public Mono<ResponseEntity<String>> loginUser(@RequestBody User user) {
        ...
        return webClient.post()
                .uri("http://ecommerce_proyect_service_users.railway.internal:3001/api/users/login")
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(user)
                .retrieve()
                .bodyToMono(String.class)
    ...
    public Mono<ResponseEntity<String>> forgetPassUser(@RequestBody User user) {
        ...
        return webClient.post()
                .uri("http://ecommerce_proyect_service_users.railway.internal:3001/api/users/forgetpass")
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(user)
                .retrieve()
                .bodyToMono(String.class)
